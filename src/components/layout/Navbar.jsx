      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center py-3 md:py-4 border-b border-gray-600/30">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            {/* Logo */}
            <Link to="/" className="flex-shrink-0 flex items-center bg-white/5 rounded p-1">
              {settings?.logo_url ? (
                <img src={settings.logo_url} alt="Logo multimedia Creative Box" className="h-16 md:h-20 object-contain" />
              ) : (

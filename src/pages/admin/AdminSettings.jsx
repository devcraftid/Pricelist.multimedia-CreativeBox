          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2 flex items-center gap-3">
              <input
                ...
                id="promo_active"
                name="promo_active"
                checked={settings.promo_active || false}
                onChange={(e) => setSettings(prev => ({ ...prev, promo_active: e.target.checked }))}
                className="w-5 h-5 text-primary border-slate-300 rounded focus:ring-primary cursor-pointer"
              />
              <label htmlFor="promo_active" className="text-sm font-medium text-slate-700 cursor-pointer">
                Tampilkan Tombol Promo di Navigasi Publik
              </label>
            </div>
            ...
            {settings.promo_active && (
              <>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Teks Tombol Promo</label>
                  <input type="text" name="promo_text" value={settings.promo_text || ''} onChange={handleChange} placeholder="Cth: PROMO AKHIR TAHUN!" className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1">Link URL Promo</label>
                  <input type="url" name="promo_link" value={settings.promo_link || ''} onChange={handleChange} placeholder="Cth: https://wa.me/... atau /price-list" className="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary outline-none" />
                </div>
              </>
            )}
          </div>

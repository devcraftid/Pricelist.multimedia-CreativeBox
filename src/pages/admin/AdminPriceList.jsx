  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-3xl font-bold text-slate-900">Paket Harga / Price List</h2>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 shadow-xl relative overflow-y-auto max-h-[90vh]">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-6">{formData.id ? 'Edit' : 'Tambah'} Paket/Item</h3>
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div>
                ...
                {formData.image_url && (
                  <img src={formData.image_url} alt="Preview" className="h-20 object-cover rounded-lg mb-3 border border-slate-200" />
                )}
